...
setwd("W:/dalgleishjl/quasar/")
# readr::write.table(path="T47D-HiChip-Neg_allValidPairs.hifive.raw",x=NegallValidPairs[,2:7],delim="\t")
# readr::write.table(path="T47D-HiChip-Pg_allValidPairs.hifive.raw",x=PgallValidPairs[,2:7],delim="\t")
#write.table(file="T47D-HiChip-Neg_allValidPairs.hifive_write.table.raw",x=NegallValidPairs[,2:7],sep="\t",row.names = F,col.names = F)
